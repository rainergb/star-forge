...
export function ReminderMenu({ onSelect, onClose }: ReminderMenuProps) {
  ...
  const options = [
    ...
    },
    {
      ...
      label: "Amanhã",
      time: new Date(Date.now() + 86400000).toLocaleDateString("pt-BR", {
        weekday: "short"
      }) + ", 09:00",
    ...
    },
    {
      ...
      time: new Date(Date.now() + 7 * 86400000).toLocaleDateString("pt-BR", {
        weekday: "short"
      }) + ", 09:00",
      ...
      <>
        ...
        <div className="absolute left-0 top-full mt-1 bg-[#1a1d3a] border border-white/10 rounded-lg shadow-xl z-20 overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-white/10">
            ...
            <span className="text-white/80 text-sm font-medium">Escolher data e hora</span>
          </div>
    ...
    <>
      ...
      <div className="absolute left-0 top-full mt-1 w-64 bg-[#1a1d3a] border border-white/10 rounded-lg shadow-xl z-20 overflow-hidden">
        ...
        >
          ...
          <span className="text-white/80 text-sm">Escolher uma data e hora</span>
        </button>
      </div>
    </>
  );
