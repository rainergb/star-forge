...
export function GeneralStatsView({
  ...
  const activeSkills = skills.filter((s) => !s.archived).length;
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-background/50 border border-white/10 rounded-lg p-4">
          ...
          <div className="text-xs text-white/40 mt-1">{completedCycles} cycles</div>
        </div>
        ...
        <div className="bg-background/50 border border-white/10 rounded-lg p-4">
          ...
          <div className="text-xs text-white/40 mt-1">total focused</div>
        </div>
        ...
        <div className="bg-background/50 border border-white/10 rounded-lg p-4">
          ...
          <div className="text-xs text-white/40 mt-1">{projects.length} total</div>
        </div>
      </div>
      ...
      <div className="bg-background/50 border border-white/10 rounded-lg p-4">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-medium text-white">{activeSkills}</span>
          </div>
        </div>
      </div>
    </div>
