...
export type DiaryDateFilterOption =
  | "all"
  | "today"
  | "yesterday"
  | "week"
...
export interface DiaryCustomDateRange {
  start: Date | null;
  end: Date | null;
}

const DATE_OPTIONS: { value: DiaryDateFilterOption; label: string }[] = [
...
interface DiaryDateFilterProps {
  selectedFilter: DiaryDateFilterOption;
  onFilterChange: (filter: DiaryDateFilterOption) => void;
  customRange?: DiaryCustomDateRange;
  onCustomRangeChange?: (range: DiaryCustomDateRange) => void;
  className?: string;
}
...
export function DiaryDateFilter({
  ...
  const handleOptionClick = (value: DiaryDateFilterOption) => {
    if (value === "custom") {
      setShowCustomPicker(true);
      if (customRange?.start) {
        setDateRange({ from: customRange.start, to: customRange.end || undefined });
      }
    } else {
